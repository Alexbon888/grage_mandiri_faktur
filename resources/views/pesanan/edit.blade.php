...
<head>
    ...
    <title>Grage Mandiri - Edit Pesanan</title>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTable" class="collapse show" aria-labelledby="headingTable"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="{{ url('item_index') }}">Daftar Item</a>

                        <a class="collapse-item" href="{{ url('pesanan_index') }}">Daftar Pesanan</a>
                    </div>
                </div>
            </li>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="kepada" value="{{ $pesanan->kepada }}" class="form-control" placeholder="Kepada">
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="polsek" value="{{ $pesanan->polsek }}" class="form-control" placeholder="Polsek">
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tanggal" value="{{ $pesanan->tanggal }}" class="form-control" placeholder="Tanggal">
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="kendaraan" value="{{ $pesanan->kendaraan }}" class="form-control" placeholder="Kendaraan">
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <strong>Nopol:</strong>
                                    <input type="text" name="nopol" value="{{ $pesanan->nopol }}" class="form-control" placeholder="Nopol">
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                                ...
                                <a> | </a>
                                <a class="btn btn-primary" href="{{ route('pesanan.index') }}">Kembali</a>
                            </div>
                        </div>
                    </form>
                </div>
