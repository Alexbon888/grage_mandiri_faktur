...
<head>
    ...
    <title>Grage Mandiri - Tambah Pesanan</title>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTable" class="collapse show" aria-labelledby="headingTable"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ url('item_index') }}">Daftar Item</a>

                        <a class="collapse-item active" href="{{ url('pesanan_index') }}">Daftar Pesanan</a>
                    </div>
                </div>
            </li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="polsek" class="form-control" placeholder="Polsek">
                                </div>
                            </div>
